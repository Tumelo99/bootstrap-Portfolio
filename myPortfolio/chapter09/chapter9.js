...
function calculateIt() {
    ...
    //get the operands
    var operand1 = document.getElementById("operand1").value;//input box
    var operand2 = document.getElementById("operand2").value;

    //get the operand types
    var select1 = document.getElementById("operand1-type");//option 1
    var select2 = document.getElementById("operand2-type");//option2
  
    var operand1type = select1.value;//values in html file
...
//if(if operand1type == ){} //convert all switches to if blocks
    ...
    for (var i = 0, length = radios.length; i < length; i++) {
        ...
        if (radios[i].checked) {
            myOperator = radios[i].value;//choose radio btn
